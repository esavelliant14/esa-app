                ...
                <form method="post" action="{{ route('bwmbw.post') }}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label">Router Hostname</label>
                                <select name="txt_hostname" class="form-select" id="id_search_hostname_bwmbw" required>
...
<!-- START MODAL ADD BWM CLIENT -->
<div class="modal fade" id="ModalAddBwmClient" tabindex="-1" aria-labelledby="newBwmClientModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newCustomerModalLabel">Add BWM Client</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{ route('bwmclient.post') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label">Router Hostname</label>
                                <select name="txt_hostname" class="form-select" id="hostname_select" required>
                                    <option value="">--- Choose Hostname ---</option>
                                    {{-- @foreach ( $hostnames as $hostname ) --}}
                                        {{-- <option value="{{ $hostname }}">{{ $hostname }}</option> --}}
                                    {{-- @endforeach --}}
                            ...
                            <div class="mb-3">
                                <label class="form-label">Interface</label>
                                <select name="txt_interface" class="form-select" id="interface_select" required>
                            ...
                            <input type="text" id="id_groupid" name="txt_id_group" value="{{ auth()->user()->id_group }}" readonly hidden>
                            <input type="text" name="txt_id_user" value="{{ auth()->user()->id }}" readonly hidden>
                        </div>
